...
function(e, n, t) {
    ...
    function i() {
        ...
        for (var a in h) {
            ...
            for (i = r(n.fn, "function") ? n.fn() : n.fn, o = 0; o < e.length; o++) s = e[o],
            f = s.split("."),
            1 === f.length ? Modernizr[f[0]] = i: (!Modernizr[f[0]] || Modernizr[f[0]] instanceof Boolean || (Modernizr[f[0]] = new Boolean(Modernizr[f[0]])), Modernizr[f[0]][f[1]] = i),
            y.push((i ? "": "no-") + f.join("-"))
        }
    }
    function o(e) {
    ...
    function f(e, n, t, r) {
        ...
        l = w("div"),
        p = s();
        if (parseInt(t, 10)) for (; t--;) f = w("div"),
        f.id = r ? r[t] : u + (t + 1),
        l.appendChild(f);
        return i = ["&#173;", '<style id="s', u, '">', e, "</style>"].join(""),
        l.id = u,
        (p.fake ? p: l).innerHTML += i,
        p.appendChild(l),
        p.fake && (p.style.background = "", p.style.overflow = "hidden", a = x.style.overflow, x.style.overflow = "hidden", x.appendChild(p)),
        o = n(l, e),
        p.fake ? (p.parentNode.removeChild(p), x.style.overflow = a, x.offsetHeight) : l.parentNode.removeChild(l),
        !!o
    }
    function a(e, n) {
        return !! ~ ("" + e).indexOf(n)
    ...
    function p(e, n, t) {
        var i;
        for (var o in e) if (e[o] in n) return t === !1 ? e[o] : (i = n[e[o]], r(i, "function") ? l(i, t || n) : i);
        return ! 1
    }
    function d(e) {
    ...
    function c(n, r) {
        ...
        if ("CSS" in e && "supports" in e.CSS) {
            for (; i--;) if (e.CSS.supports(d(n[i]), r)) return ! 0;
            return ! 1
        }
        if ("CSSSupportsRule" in e) {
            for (var o = []; i--;) o.push("(" + d(n[i]) + ":" + r + ")");
            return o = o.join(" or "),
            f("@supports (" + o + ") { #modernizr { position: absolute; } }",
            function(e) {
    ...
    function m(e, n, i, o) {
        ...
        var l, p, d, m, v;
        for (j.style || (l = !0, j.modElem = w("modernizr"), j.style = j.modElem.style), d = e.length, p = 0; d > p; p++) if (m = e[p], v = j.style[m], a(m, "-") && (m = u(m)), j.style[m] !== t) {
            if (o || r(i, "undefined")) return s(),
            "pfx" == n ? m: !0;
            try {
                j.style[m] = i
            } catch(g) {}
            if (j.style[m] != v) return s(),
            "pfx" == n ? m: !0
        }
        return s(),
        !1
    ...
    bez: function(n) {
        ...
        if ("function" != typeof jQuery.easing[r]) {
            var u = function(n, r) {
                ...
                i = function(n) {
                    for (var r, u = n,
                    e = 0; ++e < 14 && (r = l(u, 0) - n, !(Math.abs(r) < .001));) u -= r / a(u);
                    return u
                };
                return function(n) {
                    return l(i(n), 1)
...
function(e) {
    ...
    function(t) {
        ...
        R = function() {
            ...
            e(document).bind("mousemove." + f + " pointermove." + f + " MSPointerMove." + f,
            function(e) {
                if (n) {
                    var t = n.offset(),
                    a = I(e)[0] - t.top,
        ...
        E = function() {
            ...
            P.length && P.each(function() {
                e(this).load(function() {
                    L(this) && e(this.contentDocument || this.contentWindow.document).bind(z[0],
                    function(e) {
                        o(e),
                        i(e)
                    }).bind(z[1],
        ...
        W = function() {
            ...
            n && (d.length && d.each(function() {
                e(this).load(function() {
                    L(this) && e(this.contentDocument || this.contentWindow.document).bind("mousewheel." + r,
                    function(e, o) {
                        t(e, o)
                    })
                })
        ...
        P = function() {
            ...
            l.bind("touchstart." + n + " pointerdown." + n + " MSPointerDown." + n,
            function() {
                c = !0
            }).bind("touchend." + n + " pointerup." + n + " MSPointerUp." + n,
            function() {
                c = !1
            }).bind("click." + n,
            function(a) {
        ...
        H = function() {
            ...
            i.bind("scroll." + n,
            function() { (0 !== i.scrollTop() || 0 !== i.scrollLeft()) && e(".mCSB_" + o.idx + "_scrollbar").css("visibility", "hidden")
            })
        },
        U = function() {
            var t = e(this),
        ...
        q = function() {
            ...
            f.length && f.each(function() {
                e(this).load(function() {
                    L(this) && e(this.contentDocument || this.contentWindow.document).bind(h[0],
                    function(e) {
                        t(e)
                    })
                })
        ...
        Q = function(t, o, n) {
            ...
            if (s.trigger = n.trigger, (0 !== m.scrollTop() || 0 !== m.scrollLeft()) && (e(".mCSB_" + s.idx + "_scrollbar").css("visibility", "visible"), m.scrollTop(0).scrollLeft(0)), "_resetY" !== o || s.contentReset.y || (i("onOverflowYNone") && c.callbacks.onOverflowYNone.call(t[0]), s.contentReset.y = 1), "_resetX" !== o || s.contentReset.x || (i("onOverflowXNone") && c.callbacks.onOverflowXNone.call(t[0]), s.contentReset.x = 1), "_resetY" !== o && "_resetX" !== o) {
                ...
                (s.tweenRunning || !(0 === _ && S[0] >= 0 || _ === w[0] && S[0] <= w[0])) && (G(v[0], x, Math.round(S[1]), u[1], n.scrollEasing), G(h[0], x, Math.round(S[0]), u[0], n.scrollEasing, n.overwrite, {
                    onStart: function() {
    ...
    e.prototype.refresh = function() {
        ...
        for (var n in t) {
            ...
            for (var s in this.waypoints[n]) {
                ...
                p = l && h,
                u = !l && !h,
                !y && p ? (c.queueTrigger(r.backward), o[c.group.id] = c.group) : !y && u ? (c.queueTrigger(r.forward), o[c.group.id] = c.group) : y && r.oldScroll >= c.triggerPoint && (c.queueTrigger(r.forward), o[c.group.id] = c.group)
            }
        }
        ...
        return e.prototype.append = function() {
            ...
            return this.promise = this.promise.pipe(function() {
                return r.Deferred(function() {
                    ...
                    /*}catch(i){return this.reject(i),n.promise=r(n).promise()}*/
                }).promise()
            })
        },
        function() {
...
function(e) {
    window.baqemono = window.bq = window.baqemono || {
        ui: {
            ...
            config: function(t, o) {
                if (e.isPlainObject(t)) for (var n in t) e.extend(!0, this[n].defaults, t[n]);
                else "string" == typeof t && t in this && e.extend(!0, this[t].defaults, o)
            },
            plugin: function(e, t, o) {
                this[e] = t,
                this[e].defaults = void 0 === o ? {}: o
            },
            ...
            preloadImage: (function() {
                ...
                return function(t) {
                    if ("string" == typeof t && !(t in c)) {
                        ...
                        t = e.unique(t);
                        for (var n = t.length,
                        i = 0; n > i; i++) bq.util.preloadImage(t[i])
                    }
                }
            })(),
            dc: function(e, t) {
    ...
    bq.ui.plugin("rollOver",
    function(t) {
        if (t = e.extend({},
        this.defaults, t), t.offRegExp = new RegExp(t.off), t.onRegExp = new RegExp(t.on), e('a img[src*="' + t.on + '"],:image[src*="' + t.on + '"]').addClass(t.currentClass), e(document).on({
    ...
    bq.ui.plugin("fadeOver",
    function(t) {
        t = e.extend({},
        this.defaults, t),
        e(document).on("mouseover.bq.fadeOver", t.target,
        function() {
    ...
    function(t) {
        ...
        t.target),
        e(t.target).fadeTo(0, t.to, t.easing)
    },
    {
    ...
    function(t) {
        ...
        e("a[href^='http']:not([class*='popup'])" + n).addClass(t.className),
        e("area[href^='http']:not([class*='popup'])" + n).addClass(t.className),
        e(document).on("click.bq.externalLink", "a." + t.className + ",area." + t.className,
        function() {
    ...
    function(t) {
        t = e.extend({},
        this.defaults, t),
        e(document).on("click.bq.popup", "a[class*='popup']",
        function() {
            if (/(webkit)[ \/]([\w.]+)/i.test(navigator.userAgent) && !/(chrome)[ \/]([\w.]+)/i.test(navigator.userAgent)) return window.open(this.href, "_blank"),
            !1;
            var t = e(this).attr("class").match(/popup([0-9]{1,})x([0-9]{1,})/),
            o = "yes",
            n = [];
            return null !== t && (n = ["width=" + t[1], "height=" + t[2]], o = "no"),
            n = n.concat(["location=" + o, "toolbar=" + o, "directories=" + o, "status=yes", "menubar=no", "scrollbars=yes", "resizable=yes", "alwaysRaised=yes"]),
            window.name = document.domain + "_root",
            window.open(this.href, "popup" + (new Date).getTime().toString(), n.join(",")),
            !1
        }).on("click.bq.popup", "a." + t.openParentClass,
        function() {
            return window.open(this.href, document.domain + "_root"),
            !1
        })
    },
    {
    ...
    function(t) {
        ...
        this.defaults, t),
        this.go = o,
        e(document).on("click.bq.smoothScroll", 'a[href^="#"]:not(.' + t.nonScrollClass + ")",
        function() {
            return o(this.hash),
            !1
        })
    ...
    function(t) {
        ...
        t.css)).fadeTo(0, 0),
        /(webkit)[ \/]([\w.]+)/i.test(navigator.userAgent) ? e(window).unload(function() {}).load(function() {
            o.remove()
        }) : /(mozilla)(?:.*? rv:([\w.]+)|)/.test(navigator.userAgent) && e(window).bind("pageshow",
        function() {
            o.remove()
        }),
        e(window).unload(function() {}),
        e(document).on("click.bq.fadeLink", 'a:not(.external,.popup,[href^="mailto:"],[href^="#"])',
        function() {
            var n = this;
            return e("body").append(o.fadeTo(0, 0)),
            "onStart" in t && !t.onStart.apply(n) ? (o.remove(), !1) : (o.fadeTo(t.time, 1,
            function() {
                return "onComplete" in t && !t.onComplete.apply(n) ? (o.fadeTo(t.time, 0,
                function() {
                    o.remove()
    ...
    function(t) {
        if (!window.navigator.userAgent.match(/MSIE\s[678]\.0/) || !window.navigator.userAgent.match(/Windows\sNT\s[345]\./)) {
            ...
            t.css)),
            e("body").append(o),
            o.delay(t.delay).fadeTo(t.time, 0,
            function() {
                o.remove()
            })
        }
...
function() {
    ...
    function t(e, n) {
        ...
        if ("function" == typeof n) for (var i = new r(e), a = 1, o = arguments.length; o > a; ++a) t.callbacks.push(i.middleware(arguments[a]));
        else "string" == typeof e ? t["string" == typeof n ? "redirect": "show"](e, n) : t.start(e)
    }
    function e(e) {
        if (!e.handled) {
            var n;
            n = m ? v + f.hash.replace("#!", "") : f.pathname + f.search,
            n !== e.canonicalPath && (t.stop(), e.handled = !1, f.href = e.canonicalPath)
        }
    }
    function n(t, e) {
        "/" === t[0] && 0 !== t.indexOf(v) && (t = v + (m ? "#!": "") + t);
        var n = t.indexOf("?");
        if (this.canonicalPath = t, this.path = t.replace(v, "") || "/", m && (this.path = this.path.replace("#!", "") || "/"), this.title = document.title, this.state = e || {},
        this.state.path = t, this.querystring = ~n ? i(t.slice(n + 1)) : "", this.pathname = i(~n ? t.slice(0, n) : t), this.params = {},
        this.hash = "", !m) {
        ...
        if (1 === o(e) && !(e.metaKey || e.ctrlKey || e.shiftKey || e.defaultPrevented)) {
            ...
            if (n && "A" === n.nodeName && !n.hasAttribute("download") && "external" !== n.getAttribute("rel")) {
                ...
                if ((m || n.pathname !== f.pathname || !n.hash && "#" !== r) && !(r && r.indexOf("mailto:") > -1) && !n.target && s(n.href)) {
                    ...
                    a = i;
                    0 === i.indexOf(v) && (i = i.substr(v.length)),
                    m && (i = i.replace("#!", "")),
                    v && a === i || (e.preventDefault(), t.show(a))
                }
            }
        }
    }
    ...
    var h = function() {
        ...
        function o(t, o, s) {
            ...
            return h || (u = (p ? u.slice(0, -2) : u) + "(?:\\/(?=$))?"),
            u += c ? "$": h && p ? "": "(?=\\/|$)",
            e(new RegExp("^" + u, n(s)), o)
        }
    ...
    t.start = function(e) {
        if (e = e || {},
        !c && (c = !0, !1 === e.dispatch && (l = !1), !1 === e.decodeURLComponents && (d = !1), !1 !== e.popstate && window.addEventListener("popstate", w, !1), !1 !== e.click && window.addEventListener(p, a, !1), !0 === e.hashbang && (m = !0), l)) {
    ...
    t.show = function(e, r, i, a) {
        var o = new n(e, r);
        return t.current = o.path,
        !1 !== i && t.dispatch(o),
        !1 !== o.handled && !1 !== a && o.pushState(),
        o
    },
    t.back = function(e, n) {
    ...
    t.redirect = function(e, n) {
        "string" == typeof e && "string" == typeof n && t(e,
        function() {
            setTimeout(function() {
                t.replace(n)
            },
    ...
    n.prototype.pushState = function() {
        t.len++,
        history.pushState(this.state, this.title, m && "/" !== this.path ? "#!" + this.path: this.canonicalPath)
    },
    n.prototype.save = function() {
        history.replaceState(this.state, this.title, m && "/" !== this.path ? "#!" + this.path: this.canonicalPath)
    },
    n.prototype.constructor = r,
    r.prototype.middleware = function(t) {
        var e = this;
